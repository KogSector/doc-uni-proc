...
impl UnifiedProcessor {
    ...
    pub async fn new(
        ...
        let document_parser = DocumentParser::new()?;
    ...
    pub async fn store_and_publish_chunks(&self, chunks: Vec<crate::core::chunking::Chunk>, source_id: &str, _repo_name: Option<String>, user_id: &str) -> Result<()> {
